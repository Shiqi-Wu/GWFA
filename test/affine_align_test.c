...
void affine_wavefront_fetch_index(affine_wavefronts_t* affine_wavefronts, int score, affine_wavefront_index_set* index_set)
{
    ...
    index_set->in_mindex_gap = affine_wavefronts_get_source_mwavefront(affine_wavefronts,gap_open_score);
    index_set->in_iindex_ext = affine_wavefronts_get_source_iwavefront(affine_wavefronts,gap_extend_score);
    index_set->in_dindex_ext = affine_wavefronts_get_source_dwavefront(affine_wavefronts,gap_extend_score);
}

// Build new index set
void affine_wavefront_new_index_set(affine_wavefront_index_set* index_set)
{
    // I-index set
    affine_wavefront_index_t* temp = index_set->index_null;
    memcpy(temp, index_set->in_mindex_gap->idx, index_set->in_mindex_gap->idx_num * sizeof (affine_wavefront_index_t));
    temp = temp + index_set->in_mindex_gap->idx_num;
    ...
    sort(index_set->index_null,index_set->index_null + index_set->in_mindex_gap->idx_num + index_set->in_iindex_ext->idx_num,sort_index);
    int index_num = unique(index_set->index_null,index_set->index_null + index_set->in_mindex_gap->idx_num + index_set->in_iindex_ext->idx_num,unique_index)-(int)index_set->index_null;
    ...
    // M-index set
    memcpy(temp, index_set->in_mindex_sub->idx, index_set->in_mindex_sub->idx_num * sizeof (affine_wavefront_index_t));
    sort(index_set->index_null,index_set->index_null + index_set->in_mindex_gap->idx_num + index_set->in_iindex_ext->idx_num + index_set->in_mindex_sub->idx_num,sort_index);
    index_num = unique(index_set->index_null, index_set->index_null + index_set->in_mindex_gap->idx_num + index_set->in_iindex_ext->idx_num + index_set->in_mindex_sub->idx_num, unique_index);
    memcpy(index_set->out_mindex->idx, index_set->index_null, (index_num)*sizeof(affine_wavefront_index_t));
    ...
    sort(index_set->index_null,index_set->index_null + index_set->in_mindex_gap->idx_num + index_set->in_dindex_ext->idx_num,sort_index);
    int index_num = unique(index_set->index_null,index_set->index_null + index_set->in_mindex_gap->idx_num + index_set->in_dindex_ext->idx_num,unique_index)-(int)index_set->index_null;
...
void affine_wavefronts_compute_offsets_idm(
    ...
    int score){
        ...
        affine_wavefront_new_index_set(index_set);
